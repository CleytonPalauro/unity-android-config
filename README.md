...
* Documentação da Unity para [Android SDK/NDK setup](https://docs.unity3d.com/2017.3/Documentation/Manual/android-sdksetup.html);
...
* Após a instalação, abra o Android Studio, clique em *Configure>SDK Manager*. Verifique se está instalado a última versão do SDK Platform;
